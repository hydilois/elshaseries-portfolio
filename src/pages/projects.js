...
const FeaturedProject = ({ type, title, summary, img, link, github }) => {
  return (
    ...
    >
      ...
      rounded-[2.5rem] bg-dark rounded-br-3xl dark:bg-light xs:-right-3 sm:h-[102%] xs:w-full xs:rounded-[1.5rem]"
      />
      <Link
        href={link}
        target="_blank"
      ...
      <div className="w-1/2 flex flex-col items-start justify-between pl-6 lg:w-full lg:p-l-0 lg:pt-6">
...
const projects = () => {
  return (
    <>
      <Head>
        <title>Elsha Series | Projects Page</title>
